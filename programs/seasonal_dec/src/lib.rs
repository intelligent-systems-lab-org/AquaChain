...
declare_id!("ASENYNUVWkTCiEfKCiyZiBKXxRkcEfCCL7jWGgRDcpnY");
...
pub mod seasonal_dec {
    ...
    pub fn use_water(
        ...
        let rate = if consumer_watc_balance >= amount {
            ...
            consumer_wtk_balance*(consumer.reservoir_capacity/consumer.reservoir_init_capacity)     // Changed alternate rate to WaterkToken*(1 - ReservoirCap%)
        };
